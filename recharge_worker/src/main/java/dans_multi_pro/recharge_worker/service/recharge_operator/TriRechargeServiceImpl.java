...
@Service
public class TriRechargeServiceImpl implements RechargeOperatorService {
    ...
    public void executeRecharge(RechargeQueueRequestDto rechargeQueueRequestDto) {
        ...
        String id = OperatorTypeEnum.TRI.name() + "-" + rechargeQueueRequestDto.getRequestId();
