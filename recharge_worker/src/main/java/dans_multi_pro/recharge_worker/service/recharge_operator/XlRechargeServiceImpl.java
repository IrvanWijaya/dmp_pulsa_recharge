...
@Service
public class XlRechargeServiceImpl implements RechargeOperatorService {
    ...
    public void executeRecharge(RechargeQueueRequestDto rechargeQueueRequestDto) {
        ...
        String id = OperatorTypeEnum.XL.name() + "-" + rechargeQueueRequestDto.getRequestId();
